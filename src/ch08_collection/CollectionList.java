...
public class CollectionList {
    public static void main(String[] args) {
        ...
        // 다형성을 이용한 선언
        List<String> studensts3 = new ArrayList<>();
...
//        intList.add(1, 2, 3, 4, 5); 한번에 여러개의 값 못담음
        ...
        students.add("태곤");
        students.add("창연");
        students.add("10"); // int 타입의 10은 넣을 수 없다
        // 제너릭 <> 타입과 일치하는 데이터만 추가 가능  >> String타입과 int타입을 동시에 넣을 수 없다.
        ...
        System.out.println(students.contains("장선"));
        ...
        students.remove(2);
        System.out.println(students);
        System.out.println(students.size()); // 삭제 후 사이즈가 줄어듦
